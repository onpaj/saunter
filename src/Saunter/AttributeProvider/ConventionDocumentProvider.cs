...
{
    internal class ConventionDocumentProvider : IAsyncApiDocumentProvider
    {
        ...
        private readonly IAsyncApiConventionsProvider _conventionsProvider;

        public ConventionDocumentProvider(IServiceProvider serviceProvider, IAsyncApiSchemaGenerator schemaGenerator, IAsyncApiChannelUnion channelUnion, IAsyncApiDocumentCloner cloner, IAsyncApiConventionsProvider conventionsProvider)
        {
        ...
        private TypeInfo[] GetAsyncApiTypes(AsyncApiOptions options, string? apiName)
        {
            ...
            var consumers = _conventionsProvider.GetConsumers(apiName);
            var publishers = _conventionsProvider.GetPublishers(apiName);
            var messages = _conventionsProvider.GetMessages(apiName);
